...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TangibleItem.title'
        db.add_column(u'this_shop_tangibleitem', 'title',
                      self.gf('django.db.models.fields.CharField')(default='Great', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TangibleItem.title'
        db.delete_column(u'this_shop_tangibleitem', 'title')
