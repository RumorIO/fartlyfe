...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TangibleItem'
        db.create_table(u'this_shop_tangibleitem', (
        ...
        db.send_create_signal(u'this_shop', ['TangibleItem'])


    def backwards(self, orm):
        # Deleting model 'TangibleItem'
        db.delete_table(u'this_shop_tangibleitem')
