...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.pub_date_year'
        db.delete_column(u'feeds_post', 'pub_date_year')


    def backwards(self, orm):
        # Adding field 'Post.pub_date_year'
        db.add_column(u'feeds_post', 'pub_date_year',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 1, 14, 0, 0)),
                      keep_default=False)
