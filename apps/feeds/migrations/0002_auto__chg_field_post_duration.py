...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.duration'
        db.alter_column(u'feeds_post', 'duration', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Post.duration'
        db.alter_column(u'feeds_post', 'duration', self.gf('django.db.models.fields.IntegerField')())
