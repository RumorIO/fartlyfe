...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'feeds_feed', (
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photologue.Photo'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('public', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_audio_podcast', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_video_podcast', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('summary', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('explicit', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('itunes_link', self.gf('django.db.models.fields.URLField')(max_length=250, blank=True)),
            ('copyright', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('block', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('complete', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'feeds', ['Feed'])

        # Adding M2M table for field authors on 'Feed'
        m2m_table_name = db.shorten_name(u'feeds_feed_authors')
        ...
        db.send_create_signal(u'feeds', ['Topic'])
        ...
        db.create_table(u'feeds_post', (
            ...
            ('on_front', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('mimetype', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
        ...
        m2m_table_name = db.shorten_name(u'feeds_post_topics')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('post', models.ForeignKey(orm[u'feeds.post'], null=False)),
            ('topic', models.ForeignKey(orm[u'feeds.topic'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field authors on 'Feed'
        db.delete_table(db.shorten_name(u'feeds_feed_authors'))

        # Deleting model 'Topic'
        db.delete_table(u'feeds_topic')

        # Deleting model 'Post'
        db.delete_table(u'feeds_post')

        # Removing M2M table for field topics on 'Post'
        db.delete_table(db.shorten_name(u'feeds_post_topics'))
    ...
    models = {
        ...
        u'feeds.feed': {
            ...
            'is_audio_podcast': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_video_podcast': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'feeds.post': {
            ...
            'on_front': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
