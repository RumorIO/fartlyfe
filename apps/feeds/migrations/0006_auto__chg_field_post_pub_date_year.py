...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.pub_date_year'
        db.alter_column(u'feeds_post', 'pub_date_year', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Post.pub_date_year'
        db.alter_column(u'feeds_post', 'pub_date_year', self.gf('django.db.models.fields.DateTimeField')())
