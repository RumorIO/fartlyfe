...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocalEvent.price'
        db.add_column(u'local_calendar_localevent', 'price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'LocalEvent.fartlyfe_official'
        db.add_column(u'local_calendar_localevent', 'fartlyfe_official',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocalEvent.price'
        db.delete_column(u'local_calendar_localevent', 'price')

        # Deleting field 'LocalEvent.fartlyfe_official'
        db.delete_column(u'local_calendar_localevent', 'fartlyfe_official')
    ...
    models = {
        ...
        u'local_calendar.localevent': {
            ...
            'fartlyfe_official': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
