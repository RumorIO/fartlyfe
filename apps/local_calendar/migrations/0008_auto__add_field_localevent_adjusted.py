...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocalEvent.adjusted'
        db.add_column(u'local_calendar_localevent', 'adjusted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocalEvent.adjusted'
        db.delete_column(u'local_calendar_localevent', 'adjusted')
