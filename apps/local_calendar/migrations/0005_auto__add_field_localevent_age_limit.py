...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocalEvent.age_limit'
        db.add_column(u'local_calendar_localevent', 'age_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocalEvent.age_limit'
        db.delete_column(u'local_calendar_localevent', 'age_limit')
