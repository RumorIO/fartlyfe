...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocalOccurrence'
        db.create_table(u'local_calendar_localoccurrence', (
            (u'occurrence_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['calendarium.Occurrence'], unique=True, primary_key=True)),
            ('LocalEvent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='local_occurrences', to=orm['local_calendar.LocalEvent'])),
        ))
        db.send_create_signal(u'local_calendar', ['LocalOccurrence'])


    def backwards(self, orm):
        # Deleting model 'LocalOccurrence'
        db.delete_table(u'local_calendar_localoccurrence')
    ...
    models = {
        ...
        u'local_calendar.localevent': {
            'Meta': {'object_name': 'LocalEvent', '_ormbases': [u'calendarium.Event']},
            'approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'event_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['calendarium.Event']", 'unique': 'True', 'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['local_calendar.Location']", 'null': 'True', 'blank': 'True'})
        },
        u'local_calendar.localoccurrence': {
            'LocalEvent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'local_occurrences'", 'to': u"orm['local_calendar.LocalEvent']"}),
            'Meta': {'object_name': 'LocalOccurrence', '_ormbases': [u'calendarium.Occurrence']},
            u'occurrence_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['calendarium.Occurrence']", 'unique': 'True', 'primary_key': 'True'})
        },
