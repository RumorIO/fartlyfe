...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'local_calendar_location', 'website',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Location.phone_number'
        db.add_column(u'local_calendar_location', 'phone_number',
                      self.gf('localflavor.us.models.PhoneNumberField')(default=2, max_length=20),
                      keep_default=False)

        # Adding field 'Location.street_address'
        db.add_column(u'local_calendar_location', 'street_address',
                      self.gf('django.db.models.fields.CharField')(default='2', max_length=250),
                      keep_default=False)

        # Adding field 'Location.city'
        db.add_column(u'local_calendar_location', 'city',
                      self.gf('django.db.models.fields.CharField')(default='2', max_length=250),
                      keep_default=False)

        # Adding field 'Location.state'
        db.add_column(u'local_calendar_location', 'state',
                      self.gf('localflavor.us.models.USStateField')(default='KS', max_length=2),
                      keep_default=False)

        # Adding field 'Location.zipcode'
        db.add_column(u'local_calendar_location', 'zipcode',
                      self.gf('django.db.models.fields.CharField')(default='2', max_length=5),
                      keep_default=False)

        # Adding field 'Location.latitude'
        db.add_column(u'local_calendar_location', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.longitude'
        db.add_column(u'local_calendar_location', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'local_calendar_location', 'website')

        # Deleting field 'Location.phone_number'
        db.delete_column(u'local_calendar_location', 'phone_number')

        # Deleting field 'Location.street_address'
        db.delete_column(u'local_calendar_location', 'street_address')

        # Deleting field 'Location.city'
        db.delete_column(u'local_calendar_location', 'city')

        # Deleting field 'Location.state'
        db.delete_column(u'local_calendar_location', 'state')

        # Deleting field 'Location.zipcode'
        db.delete_column(u'local_calendar_location', 'zipcode')

        # Deleting field 'Location.latitude'
        db.delete_column(u'local_calendar_location', 'latitude')

        # Deleting field 'Location.longitude'
        db.delete_column(u'local_calendar_location', 'longitude')
    ...
    models = {
        ...
        u'local_calendar.localevent': {
            'Meta': {'object_name': 'LocalEvent'},
            'approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['calendarium.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['local_calendar.Location']", 'null': 'True', 'blank': 'True'})
        },
        u'local_calendar.location': {
