...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'local_calendar_location', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255)),
        ))
        db.send_create_signal(u'local_calendar', ['Location'])

        # Adding model 'LocalEvent'
        db.create_table(u'local_calendar_localevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendarium.Event'])),
            ('approved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['local_calendar.Location'], null=True, blank=True)),
        ))
        db.send_create_signal(u'local_calendar', ['LocalEvent'])


    def backwards(self, orm):
        # Deleting model 'Location'
        db.delete_table(u'local_calendar_location')

        # Deleting model 'LocalEvent'
        db.delete_table(u'local_calendar_localevent')
