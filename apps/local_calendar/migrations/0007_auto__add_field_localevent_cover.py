...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocalEvent.cover'
        db.add_column(u'local_calendar_localevent', 'cover',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['photologue.Photo']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocalEvent.cover'
        db.delete_column(u'local_calendar_localevent', 'cover_id')
    ...
    models = {
        ...
        u'local_calendar.localevent': {
            ...
            'fartlyfe_official': ('django.db.models.fields.BooleanField', [], {}),
